...
import PaymentMethodHolder from './PaymentMethodHolder';
      ...
      <div id="__next">
        <div className="sc-4f945396-0 bejlYW">
          <div className="sc-4f945396-1 kLIYyQ">
            ...
            <div className={`transition-container ${isAddressSaved ? 'fade-out' : 'fade-in'}`}>
              {isAddressSaved ? (
                <AddressSummary onEdit={handleAddressEdit} />
              ) : (
                <AddressForm onSave={handleAddressSave} initialData={editData} />
              )}
            </div>
            <div className={`transition-container ${isAddressSaved ? 'fade-in' : 'fade-out'}`}>
              {isAddressSaved ? <PaymentMethodForm ref={paymentMethodFormRef} /> : <PaymentMethodHolder ref={paymentMethodFormRef} />}
            </div>
          </div>
